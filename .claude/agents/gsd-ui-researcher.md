...
Use template from `/Users/zhongyang/Desktop/个人工作/study/ragent/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/zhongyang/Desktop/个人工作/study/ragent/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/zhongyang/Desktop/个人工作/study/ragent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```

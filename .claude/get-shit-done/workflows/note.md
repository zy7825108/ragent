...
- **Global scope**: `/Users/zhongyang/Desktop/个人工作/study/ragent/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/zhongyang/Desktop/个人工作/study/ragent/.claude/notes/`)
...
2. Glob `/Users/zhongyang/Desktop/个人工作/study/ragent/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/zhongyang/Desktop/个人工作/study/ragent/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/zhongyang/Desktop/个人工作/study/ragent/.claude/notes/` — works in any directory
